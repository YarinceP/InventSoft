...
-- -----------------------------------------------------
-- Table `inventsoft`.`tbl_properdido`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `inventsoft`.`tbl_properdido` (
...
-- -----------------------------------------------------
-- Table `inventsoft`.`tbl_accesos_has_tbl_usuarios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `inventsoft`.`tbl_accesos_has_tbl_usuarios` (
  ...
  CONSTRAINT `fk_tbl_accesos_has_tbl_usuarios_tbl_accesos1`
    ...
    REFERENCES `inventsoft`.`tbl_accesos` (`id_accesos`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
